...
graph TB
    ...
    subgraph "Access"
        I --> K[grafana.jrb.nz]
        D --> L[prometheus.jrb.nz]
        H --> M[alertmanager.jrb.nz]
        B --> N[loki.jrb.nz]
    end
```
...
- **Grafana**: https://grafana.jrb.nz (admin/prom-operator)
- **Prometheus**: https://prometheus.jrb.nz
- **Alertmanager**: https://alertmanager.jrb.nz
- **Loki**: https://loki.jrb.nz
...
# Visit: https://prometheus.jrb.nz/targets
```
...
# Check firing alerts
# Visit: https://prometheus.jrb.nz/alerts
```
...
# Check Loki targets
# Visit: https://loki.jrb.nz/targets
```
