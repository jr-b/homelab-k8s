...
- Wildcard DNS `*.jrb.nz` pointed to Cloudflare Tunnel
...
1. Go to Cloudflare DNS for `jrb.nz`
2. Look at any existing CNAME record (like `search.jrb.nz`)
...
dig search.jrb.nz @1.1.1.1
dig proxitok.jrb.nz @1.1.1.1
dig libreddit.jrb.nz @1.1.1.1
dig karakeep.jrb.nz @1.1.1.1
dig vert.jrb.nz @1.1.1.1
dig it-tools.jrb.nz @1.1.1.1
...
curl -I https://search.jrb.nz
curl -I https://proxitok.jrb.nz
# etc...
```
